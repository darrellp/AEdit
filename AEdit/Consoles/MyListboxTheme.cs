...
namespace SadConsole.Themes
{
	...
	public class MyListBoxTheme : ThemeBase<MyListBox>
	{
		...
		/// </summary>
		[DataMember]
		public MyListBoxItemTheme ItemTheme;
		...
		public MyListBoxTheme()
		{
			...
			ItemTheme = new MyListBoxItemTheme();
		...
		public override object Clone()
		{
			return new MyListBoxTheme()
			{
				...
				ItemTheme = (MyListBoxItemTheme)ItemTheme.Clone(),
		...
		public MyListBoxTheme(ListBoxTheme lbTheme)
		{
			...
			MouseOver = lbTheme.MouseOver.Clone();
			MouseDown = lbTheme.MouseDown.Clone();
			Selected = lbTheme.Selected.Clone();
			Focused = lbTheme.Focused.Clone();
			BorderTheme = lbTheme.BorderTheme.Clone();
			BorderLineStyle = (int[])lbTheme.BorderLineStyle.Clone();
			DrawBorder = lbTheme.DrawBorder;
			//ItemTheme = (MyListBoxItemTheme)lbTheme.ItemTheme.Clone();
			ItemTheme = new MyListBoxItemTheme((ListBoxItemTheme)lbTheme.ItemTheme.Clone());
			ScrollBarTheme = (ScrollBarTheme) lbTheme.ScrollBarTheme.Clone();
		}
	}

	public class MyListBoxItemTheme : ThemeStates
	{
		public MyListBoxItemTheme()
		{
			SetForeground(Normal.Foreground);
			SetBackground(Normal.Background);
		...
		public virtual void Draw(SurfaceBase surface, Rectangle area, object item, ControlStates itemState)
		{
		...
		public MyListBoxItemTheme(ListBoxItemTheme lbtheme)
		{
			Normal = lbtheme.Normal.Clone();
			Disabled = lbtheme.Disabled.Clone();
			MouseOver = lbtheme.MouseOver.Clone();
	...
	//public class MyListBoxItemColorTheme : MyListBoxItemTheme
	//{
	...
	//	public override object Clone()
	//	{
	//		return new MyListBoxItemColorTheme()
	//		{
	//			Normal = Normal.Clone(),
	//			Disabled = Disabled.Clone(),
	//			MouseOver = MouseOver.Clone(),
